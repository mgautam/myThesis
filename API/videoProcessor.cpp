...
/*
	FEATURES train;
	FILE *featureFile = fopen ("./TestRepo/01.Training/07.SIFT_Keys/train.bin","rb");	
...
/*		sprintf (filename, "./TestRepo/02.Test/07.SIFT_Keys/testFeature(%d).bin",frameIndex);
